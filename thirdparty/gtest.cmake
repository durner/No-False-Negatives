...
ExternalProject_Add(
    gtest_src
    PREFIX "thirdparty/gtm"
    SOURCE_DIR "thirdparty/gtm/src/googletest/googletest"
    INSTALL_DIR "thirdparty/gtm/gtest"
    CMAKE_ARGS
        -DCMAKE_INSTALL_PREFIX=${CMAKE_BINARY_DIR}/thirdparty/gtm/gtest
...
#    gmock_src
#    PREFIX "thirdparty/gtm"
#    SOURCE_DIR "thirdparty/gtm/src/googletest/googlemock"
#    INSTALL_DIR "thirdparty/gtm/gmock"
#    CMAKE_ARGS
#        -DCMAKE_INSTALL_PREFIX=${CMAKE_BINARY_DIR}/thirdparty/gtm/gmock
#        -DCMAKE_C_COMPILER=${CMAKE_C_COMPILER}
#        -DCMAKE_CXX_COMPILER=${CMAKE_CXX_COMPILER}
#        -DCMAKE_CXX_FLAGS=${CMAKE_CXX_FLAGS}
#    DOWNLOAD_COMMAND ""
