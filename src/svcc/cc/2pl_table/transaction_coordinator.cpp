...
thread_local std::unordered_set<uint64_t>
    transaction::TransactionCoordinator<common::StdAllocator>::abort_transaction_{};
template <>
thread_local std::unordered_set<uint64_t>
    transaction::TransactionCoordinator<common::ChunkAllocator>::abort_transaction_{};

template <>
thread_local std::list<transaction::TransactionInformationBase<common::StdAllocator>*>*
    transaction::TransactionCoordinator<common::StdAllocator>::atom_info_{};
template <>
thread_local std::list<transaction::TransactionInformationBase<common::ChunkAllocator>*>*
